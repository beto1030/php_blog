      ...
      , B = function() {
        ...
        return s(t, [{
            ...
            value: function(t, e, i) {
                ...
                l < 1e-5 && r && e < 10 ? e *= 1.05 : i > .1 && i < 3 && r && (e += i / 3);
                var h = a + 1;
                h < 2 ? h = 2 : h > 2 && (h -= 2);
                for (var c = l / h, u = Math.floor(d.log10(c)), g = Math.pow(10, u), f = parseInt(c / g) * g, p = f * Math.floor(t / f), x = f * Math.ceil(e / f), b = p; o.push(b),
                !((b += f) > x); )
                    ;
                if (r)
                    return {
    ...
    var st, at, nt = function() {
        ...
        return s(t, [{
            ...
            value: function(t) {
                ...
                i.e = a,
                !i.hasBars() || n.globals.comboCharts || i.isBarShared) || this.tConfig.onDatasetHover.highlightDataSeries && new G(e).toggleSeriesOnHover(a, a.target.parentNode);
