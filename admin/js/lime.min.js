$(document).ready(function() {
    ...
    !function() {
        1 === $(".material-design-hamburger__icon").length && document.querySelector(".material-design-hamburger__icon").addEventListener("click", function() {
            ...
            (e = this.childNodes[1].classList).contains("material-design-hamburger__icon--to-arrow") ? (e.remove("material-design-hamburger__icon--to-arrow"),
        ...
        $(".navigation-toggle a").on("click", function() {
            return $("body").toggleClass("sidebar-show"),
            !1
        });
        var e = $(".accordion-menu li:not(.open) .sub-menu")
        ...
        $(".accordion-menu li a").on("click", function() {
            ...
            if (e.length)
                return o.hasClass("open") ? ($(".open .sub-menu li").each(function(e) {
                    var o = $(this);
                    setTimeout(function() {
                ...
                e.slideUp(200),
                o.removeClass("open")) : (n.length && ($(".accordion-menu > li.open > .sub-menu").slideUp(200),
                n.removeClass("open")),
                e.slideDown(200),
                o.addClass("open"),
    ...
    $(".theme-settings-link").on("click", function() {
        return $("body").toggleClass("show-theme-settings"),
        !1
    }),
    $("#search input").on("input", function() {
        var e = $(this).val();
        e.length > 0 ? ($("body").addClass("searching"),
        $("span.search-input-value").html(e)) : $("body").removeClass("searching"),
        ...
        window.addEventListener("load", function() {
            ...
            Array.prototype.filter.call(e, function(e) {
                e.addEventListener("submit", function(o) {
                    !1 === e.checkValidity() && (o.preventDefault(),
                    o.stopPropagation()),
